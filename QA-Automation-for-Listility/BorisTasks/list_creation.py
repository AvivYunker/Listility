class ListCreation: # definition of class, it's PascalCasing.
    def __init__(self, driver): # this is a constructor ("banai") that's used to initialize every class.
        ...
        # if the function doesn't need to return anything, then we type "return None" just that there will be a return statement
...
# Test
test_object = ListCreation(browser) # defining the object to be an object of the class "ListCreation", and pass "driver" (declared on line 48) to the constructor ("banai")
...
is_success = test_object.confirm_list_creation("Sample List") # here - we're calling the "create_new_task" method of the class "TaskCreation" (making the "submit_username_password" function run)
