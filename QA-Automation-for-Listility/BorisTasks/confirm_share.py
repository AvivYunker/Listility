class LoginTest:
    ...
    def open_share(self):
        ...
        share_list_button = self.driver.find_element_by_id('ShareListButton')
        share_list_button.click()

    def confirm_share(self, expected_text):
        share_list_header = self.driver.find_element_by_id('ShareListHeader').text
        return (share_list_header == expected_text)
...
test_object.open_share()
is_success = test_object.confirm_share("Share List")
