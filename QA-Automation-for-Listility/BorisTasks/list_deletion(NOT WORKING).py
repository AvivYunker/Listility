class LoginTest:
    ...
    def delete_list(self):
        time.sleep(1)
        delete_button = self.driver.find_element_by_id('DeleteListButton')
        delete_button.click()
    
    def confirm_list_deletion(self, expected_text):
        no_lists_header = self.driver.find_element_by_id('NoListsHeader').text
        return (no_lists_header == expected_text)
...
test_object.delete_list()
is_success = test_object.confirm_list_deletion("No lists to display...")
