class LoginTest: # definition of class, it's PascalCasing.
...
# Test
test_object = LoginTest(browser) # defining the object to be an object of the class "LoginTest", and pass "driver" (declared on line 48) to the constructor ("banai")
...
# also - we're passing the 2 parameters, which are: "test4@gmail.com" and "123123"
...
is_success = test_object.confirm_login_success("Welcome, Test!") # the "confirm_register_success" returns a value. This value will be stored in "is_success" for future use 
